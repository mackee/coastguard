...
type Options struct {
	...
	UnauthorizedStatusCode     int            `kong:"name='unauthorized-status-code',help='Unauthorized Status Code',default='0',env='UNAUTHORIZED_STATUS_CODE'"`
	NotAllowedDomainStatusCode int            `kong:"name='not-allowed-domain-status-code',help='Not Allowed Domain Status Code',default='0',env='NOT_ALLOWED_DOMAIN_STATUS_CODE'"`
}
